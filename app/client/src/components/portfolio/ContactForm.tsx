...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="w-full border-t border-slate-900 py-24">
      <div className="max-w-7xl mx-auto w-full px-8 md:px-12 grid lg:grid-cols-12 gap-16 items-start">
        <div className="lg:col-span-5">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-500" />
            <span className="text-xs font-semibold text-cyan-400 uppercase tracking-widest">Contact</span>
          </div>
          <h2 className="section-title text-4xl mb-4 font-extrabold tracking-tight">Let's talk</h2>
          <p className="text-slate-400 leading-relaxed mb-8">
            Got a project in mind, a job opportunity, or just want to say hi? Send a message and I'll get back to you.
          </p>
          <div className="space-y-4">
            <a href="mailto:plibersek.daniel@gmail.com" className="flex items-center gap-3.5 text-slate-400 hover:text-cyan-400 transition-colors">
            ...
            <a href="https://github.com/slogiker" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3.5 text-slate-400 hover:text-cyan-400 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-slate-800 border border-slate-700/50 flex items-center justify-center">
        ...
        <div className="card p-10 lg:col-span-7 bg-[#111015]/60 hover:bg-slate-800/30 transition-all duration-300">
          {state === 'success' ? (
